...
<div class="container">
    <div class="card shadow-card user-list-card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h2 class="card-heading">Tax and Price</h2>
                    ...
                    @foreach($taxs as $tax)
                        <tr>
                            ...
                            <td style="d-flex; gap:2px;">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#editRoom{{ $tax->id }}" class="btn btn-primary btn-sm">Edit</a>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header bg-light p-3">
                                <h5 class="modal-title" id="exampleModalLabel">Edit Tax and Price</h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="room_tye" value="" required autocomplete="off">
                                            </div>
                                        </div>
...
<div class="modal fade" id="addTaxModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-light p-3">
                <h5 class="modal-title" id="exampleModalLabel">Add Tax Price</h5>
