<div id="scrollbar">
	<div class="container-fluid">
		...
		<ul class="navbar-nav" id="navbar-nav">
			...
			<!-- end Dashboard Menu -->
			<li class="nav-item">
				<a href="{{ route('admin.users.list') }}" class="nav-link menu-link">
					<i class="mdi mdi-account-circle-outline"></i> <!-- Profile Icon -->
					<span data-key="t-users">Users</span>
				</a>
			</li>
			<li class="nav-item">
				<a href="{{ route('admin.vendorList') }}" class="nav-link menu-link">
				<i class="mdi mdi-account-circle-outline"></i><span data-key="t-users">Vendors</span>
				</a>
			</li>
			<li class="nav-item">
				<a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
				<i class="mdi mdi-view-grid-plus-outline"></i> <span data-key="t-apps">Properties</span>
				</a>
				<div class="collapse menu-dropdown" id="sidebarApps">
					<ul class="nav nav-sm flex-column">
						<li class="nav-item">
							<a href="{{ route('admin.propertyCategory') }}" class="nav-link" data-key="t-calendar"> Add Category </a>
						</li>
						<li class="nav-item">
							<a href="{{ route('admin.propertyList') }}" class="nav-link" data-key="t-chat">Property List</a>
						</li>
						<li class="nav-item">
							<a href="{{ route('admin.addFacilitiesView') }}" class="nav-link" data-key="t-chat"> Add Facilities </a>
						</li>
					</ul>
				</div>
			</li>
			<!-- <li class="nav-item">
				<a class="nav-link menu-link" href="#sidebarSubscriptions" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarSubscriptions">
				    <i class="mdi mdi-view-grid-plus-outline"></i> <span data-key="t-apps">Subscriptions</span>
				</a>
				<div class="collapse menu-dropdown" id="sidebarSubscriptions">
				    <ul class="nav nav-sm flex-column">
				        <li class="nav-item">
				            <a href="/clockwisehotel/public/admin/subscriptions" class="nav-link" data-key="t-calendar">Newsletter Subscriptions</a>
				        </li>
				    </ul>
				</div>
				</li> -->
			<li class="nav-item">
				<a href="{{ route('admin.subscriptions') }}" class="nav-link menu-link">
				<i class="mdi mdi-view-grid-plus-outline"></i><span data-key="t-users">Subscriptions</span>
				</a>
			</li>
			<li class="nav-item">
				<a href="{{ route('admin.propertyWeekendDeal') }}" class="nav-link menu-link">
				<i class="mdi mdi-view-grid-plus-outline"></i><span data-key="t-users">Weekend Deal Property</span>
				</a>
			</li>
			<li class="nav-item">
				<a href="{{ route('admin.treanding.destination') }}" class="nav-link menu-link">
				<i class="mdi mdi-view-grid-plus-outline"></i><span data-key="t-users">Trending Destination</span>
				</a>
			</li>
			<li class="nav-item">
				<a class="nav-link menu-link" href="#trending-destination-homepage" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="trending-destination-homepage">
				<i class="mdi mdi-view-grid-plus-outline"></i> <span data-key="t-apps">Trending Destination HomePage</span>
				</a>
				<div class="collapse menu-dropdown" id="trending-destination-homepage">
					<ul class="nav nav-sm flex-column">
						<li class="nav-item">
							<a href="{{ route('admin.trending-destination') }}" class="nav-link" data-key="t-calendar">Add Destination</a>
						</li>
					</ul>
				</div>
			</li>
			<li class="nav-item">
				<a class="nav-link menu-link" href="#CMS" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="CMS">
				<i class="mdi mdi-view-grid-plus-outline"></i> <span data-key="t-apps">CMS</span>
				</a>
				<div class="collapse menu-dropdown" id="CMS">
					<ul class="nav nav-sm flex-column">
						<li class="nav-item">
							<a href="{{ route('admin.home') }}" class="nav-link" data-key="t-calendar">Home</a>
						</li>
						<li class="nav-item">
							<a href="{{ route('admin.about-us') }}" class="nav-link" data-key="t-calendar">About-Us</a>
						</li>
						<li class="nav-item">
							<a href="{{ route('admin.contact-us') }}" class="nav-link" data-key="t-calendar">Contact-Us</a>
						</li>
						<li class="nav-item">
							<a href="{{ route('admin.privacy-policy') }}" class="nav-link" data-key="t-calendar">Privacy-Policy</a>
						</li>
						<li class="nav-item">
							<a href="{{ route('admin.terms-and-conditions') }}" class="nav-link" data-key="t-calendar">Terms And Conditions</a>
						</li>
						<li class="nav-item">
							<a href="{{ route('admin.footer') }}" class="nav-link" data-key="t-calendar">Footer</a>
						</li>
					</ul>
				</div>
			</li>
			<!-- <li class="nav-item">
				<a href="{{ route('admin.tax-rate') }}" class="nav-link menu-link">
				    <i class="mdi mdi-view-grid-plus-outline"></i><span data-key="t-users">Room Price</span>
				</a>
				</li>
				
				<li class="nav-item">
				<a href="{{ route('admin.room-type') }}" class="nav-link menu-link">
				    <i class="mdi mdi-view-grid-plus-outline"></i><span data-key="t-users">Room Type</span>
				</a>
				</li>
				-->
			<li class="nav-item">
				<a href="{{ route('admin.show.comment') }}" class="nav-link menu-link">
				<i class="mdi mdi-view-grid-plus-outline"></i><span data-key="t-users">Comments</span>
				</a>
			</li>
			<li class="nav-item">
				<a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
				<i class="mdi mdi-view-grid-plus-outline"></i> <span data-key="t-apps">Login Management</span>
				</a>
				<div class="collapse menu-dropdown" id="sidebarApps">
					<ul class="nav nav-sm flex-column">
						<li class="nav-item">
							<a href="{{ route('admin.log.detail') }}" class="nav-link" data-key="t-calendar"> Admin Login </a>
						</li>
						<li class="nav-item">
							<a href="{{ route('admin.vendor.log.detail') }}" class="nav-link" data-key="t-chat">Vendor Login</a>
						</li>
					</ul>
				</div>
			</li>
            <li class="nav-item">
				...
				<i class="mdi mdi-share-variant-outline"></i> <span data-key="t-multi-level">Booking Management</span>
				</a>
				<div class="collapse menu-dropdown" id="sidebarMultilevel">
					<ul class="nav nav-sm flex-column">
						<li class="nav-item">
							<a href="{{ route('admin.hotel.detail.listing') }}" class="nav-link" data-key="t-level-1.1"> Hotel Booking </a>
						</li>
