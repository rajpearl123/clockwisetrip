...
<head>
    ...
    <meta charset="utf-8" />
    <title>Clock Wise Hotel - Vendor Register</title>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <a href="{{ route('vendor.login') }}"> <p class="text-muted">Already have an account ? Signin</p> </a>
                                </div>

                                <form action="{{ route('vendor.register') }}" method="POST">
                                    @csrf
                                    <div class="p-2 mt-4">
                                        <form class="needs-validation" novalidate action="http://www.themesbrand.com/velzon/html/material/index.html">
    
                                            <div class="mb-3">
                                                <label for="name" class="form-label">Name<span class="text-danger">*</span></label>
                                                <input type="text" class="form-control user_name" name="name" placeholder="Enter Your Name" autocomplete="one-time-code" required>
                                                <span class="error text-danger" id="nameError"></span>
                                            </div>

                                            <div class="mb-3">
                                                <label for="useremail" class="form-label">Email <span class="text-danger">*</span></label>
                                                <input type="email" class="form-control email_input" id="useremail" name="email" autocomplete="one-time-code" placeholder="Enter email address" required>
                                            ...
                                            <div class="mb-3">
                                                <label for="username" class="form-label">Mobile No <span class="text-danger">*</span></label>
                                                <input type="number" class="form-control mobile_number" name="mobile_no" placeholder="Enter Mobile No" autocomplete="one-time-code" required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="position-relative auth-pass-inputgroup">
                                                    <input type="password" name="password" class="form-control pe-5 password-input" autocomplete="one-time-code" onpaste="return false" placeholder="Enter password" id="password-input" aria-describedby="passwordInput" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                                            ...
                                            <div class="mt-4">
                                               <a href=""> <button class="btn btn-success w-100" type="submit">Sign Up</button> </a> 
                                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> All Rights Reversed By <i class="mdi mdi-heart text-danger"></i>Clock Wise Hotel 
                            </p>
                        </div>
                    </div>
                </div>
