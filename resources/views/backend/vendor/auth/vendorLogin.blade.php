...
<head>
    ...
    <meta charset="utf-8" />
    <title>Clock Wise Hotel - Vendor Login</title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form class="needs-validation" novalidate action="{{ route('vendor.login') }}" method="POST">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="useremail" class="form-label">Email <span class="text-danger">*</span></label>
                                            <input type="email" class="form-control email_input" name="email" id="useremail" placeholder="Enter email address" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                <input type="password" class="form-control pe-5 password-input" name="password" onpaste="return false" placeholder="Enter password" aria-describedby="passwordInput" required>
                                        ...
                                        <div class="mt-4 text-center">
                                            <div class="signin-other-title">
                                                <a href="{{ route('vendor.register') }}">
                                                    <h5 class="fs-13 mb-4 title text-muted">Sign Up</h5>
                                                </a>
                                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                ...
                                </script> All Rights Reversed By <i class="mdi mdi-heart text-danger"></i>Clock Wise Hotel
                            </p>
                        </div>
                    </div>
                </div>
