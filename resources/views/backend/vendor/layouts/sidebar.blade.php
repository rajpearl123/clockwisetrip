    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav" id="navbar-nav">
            <li class="menu-title"><span data-key="t-menu">Menu</span></li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ url('vendor/dashboard') }}">
            ...
            <li class="nav-item">
                <a class="nav-link menu-link" href="{{ route('vendor.profile') }}" >
                        <i class="mdi mdi-cube-outline"></i> <span data-key="t-base-ui">Profile </span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link menu-link {{ request()->routeIs('vendor.addPropertyView', 'vendor.propertyListView') ? 'active' : '' }}" 
                href="#sidebarLayouts" 
                data-bs-toggle="collapse" 
                role="button" 
                aria-expanded="{{ request()->routeIs('vendor.addPropertyView', 'vendor.propertyListView') ? 'true' : 'false' }}" 
                aria-controls="sidebarLayouts">
                    <i class="mdi mdi-home-outline"></i> 
                    <span data-key="t-layouts">Property</span>
                </a>
                <div class="collapse menu-dropdown {{ request()->routeIs('vendor.addPropertyView', 'vendor.propertyListView') ? 'show' : '' }}" id="sidebarLayouts">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('vendor.addPropertyView') }}" 
                            class="nav-link {{ request()->routeIs('vendor.addPropertyView') ? 'active-option' : '' }}" 
                            data-key="t-hovered">Add Property</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('vendor.propertyListView') }}" 
                            class="nav-link {{ request()->routeIs('vendor.propertyListView') ? 'active-option' : '' }}" 
                            data-key="t-two-column">Property List</a>
                        </li>
                    </ul>
                </div>
            </li>
            <span class="booking-management-heading mt-3">
                <h5 class="px-3 py-2 text-white mt-3"><strong>Booking Management</strong></h5>
            </span>
            <li class="nav-item-booking">
                <a class="nav-link menu-link {{ Request::is('vendor/bookings*') ? 'active' : '' }}"
                    href="#sidebarBookings" 
                    data-bs-toggle="collapse" 
                    role="button" 
                    aria-expanded="{{ Request::is('vendor/bookings*') ? 'true' : 'false' }}" 
                    aria-controls="sidebarBookings">
                        <i class="mdi mdi-home-outline"></i> 
                        <span data-key="t-layouts">Bookings</span>
                </a>
                <div class="collapse menu-dropdown-booking {{ Request::is('vendor/bookings*') ? 'show' : '' }}" id="sidebarBookings">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('vendor.booking.list') }}" 
                            class="nav-link {{ Request::is('vendor/bookings/list') ? 'active-option' : '' }}" 
                            data-key="t-hovered">Booking List</a>
                        </li>
                    </ul>
                </div>
            </li>
