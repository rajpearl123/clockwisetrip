                ...
                <div class="dropdown ms-sm-3 header-item topbar-user" style="background-color:#212529">
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{{ asset('/images/vendor/profile/'. Auth::guard('vendor')->user()->image)}}" alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 text-white fw-medium user-name-text" style="font-size:16px;">{{ ucwords(Auth::guard('vendor')->user()->name) ?? '' }}</span>
