<div id="scrollbar">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.users.list') }}" class="nav-link"> <i class="mdi mdi-view-grid-plus-outline"></i>Users</a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarApps">
                    <ul class="nav nav-sm flex-column">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.propertyList') }}" class="nav-link" data-key="t-chat"> Add Property </a>
                        </li>
                    </ul>
                </div>
