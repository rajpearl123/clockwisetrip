                        ...
                        <div class="px-50 py-50 sm:px-20 sm:py-20 bg-white shadow-4 rounded-4">
                            <div class="row y-gap-20">
                                <div class="col-12">
                                    ...
                                    <p class="mt-10">Already have an account? <a href="{{ route('property.login') }}" class="text-blue-1">Log in</a></p>
                                </div>

                                <form action="{{ route('property.register') }}" method="POST" class="sign-up-form">
                                    @csrf
                                    <div class="col-12 mb-5">
                                        <div class="form-input">
                                            <input type="text" required name="name" value="{{ old('name') }}" autocomplete="one-time-code" />
                                    ...
                                    <div class="col-12">
                                        <div class="form-input">
                                            <input type="email" name="email" required value="{{ old('email') }}" autocomplete="one-time-code" />
                    ...
                    <div class="row y-gap-40 justify-between xl:justify-start">
                        <div class="col-xl-2 col-lg-4 col-sm-6">
                            ...
                            <div class="mt-35">
                                ...
                                <a href="#" class="text-18 fw-500 text-blue-1 mt-5">hi@clockwisehotel.com</a>
                            </div>
                        </div>
    ...
    <!-- <div class="langMenu is-hidden js-langMenu" data-x="lang" data-x-toggle="is-hidden">
        ...
        <div class="langMenu__content bg-white rounded-4">
            ...
            <div class="modalGrid px-30 py-30 sm:px-15 sm:py-15">
                ...
                <div class="modalGrid__item js-item">
                    <div class="py-10 px-15 sm:px-5 sm:py-5">
                        <div class="text-15 lh-15 fw-500 text-dark-1">T�rk�e</div>
                ...
                <div class="modalGrid__item js-item">
                    <div class="py-10 px-15 sm:px-5 sm:py-5">
                        <div class="text-15 lh-15 fw-500 text-dark-1">Espa�ol</div>
                        <div class="text-14 lh-15 mt-5 js-title">Espa�a</div>
                    </div>
                </div>

                <div class="modalGrid__item js-item">
                    <div class="py-10 px-15 sm:px-5 sm:py-5">
                        <div class="text-15 lh-15 fw-500 text-dark-1">Fran�ais</div>
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Aug 2024 07:30:04 GMT -->
