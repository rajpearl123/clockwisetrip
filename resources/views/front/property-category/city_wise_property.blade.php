...
<section class="py-50" style="margin-top: 80px;background-color: #f4f5f6;">
    <div class="container">
        <div class="row">
            @foreach($city_wise_property as $property)
            <div class="col-md-4">
                <a href="{{ route('trendingDestinationDetailss', $property->slug) }}">
                    <div class="categorycardsItems">
                        ...
                        <div id="carousel{{ $property->id }}" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item {{ $key === 0 ? 'active' : '' }}">
                                    <img src="{{ asset('front/img/propertys/'.$image) }}" class="d-block w-100 carousel-image" alt="{{ $property->title }}">
                                </div>
                                @endforeach
                            </div>
                        ...
                        <div class="categoryCardsContent">
                            ...
                            <p>{{ Str::limit(strip_tags($property->description, 160)) }}</p>
                            <a href="{{ route('trendingDestinationDetailss', $property->slug) }}" class="categoryCardsLink">Read More</a>
                        </div>
                    </div>
                </a>
            </div>
